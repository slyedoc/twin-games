// Nearly all of this is from bevy renderer, duplicating for easy of use in egui
mod capsule;
mod icosphere;
mod torus;
mod uvsphere;
...
use bevy::{
    ...
    }, prelude::{App, Plugin, Commands, Added, Or, Entity, Query, ResMut, Assets, Changed, Component},
};
