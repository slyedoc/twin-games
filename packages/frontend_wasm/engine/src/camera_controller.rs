use bevy::{core::Time, input::{mouse::MouseMotion, Input}, math::{EulerRot, Quat, Vec2, Vec3}, prelude::{Added, EventReader, KeyCode, MouseButton, Plugin, Query, Res, ResMut, Transform, With, Component}, render2::camera::Camera, window::Windows};
...
fn init_camera_controller(
    mut query: Query<
        ...
        (Added<CameraController>, With<Camera>),
    >,
) {
